...
4. **`maquette_interface/bail/bail.html` reste la référence de structure et de fonctionnement du projet.** Elle couvre les 15 écrans du parcours (recherche, fiche annonce, espace propriétaire, dossier locataire, candidature, visite, bail, honoraires, back-office) pour les 3 profils. Conserve les typographies, composants et comportements établis. **Évolution demandée le 7 septembre 2026 :** le plan d’accueil est remplacé par une maison fictive en coupe ; la palette devient claire et méditerranéenne (crème, beige pierre, olive, sauge, bois et vert herbe), selon `docs/design-system.md`. Ces couleurs remplacent le vert forêt et le thème sombre automatique de la maquette. Le nom du produit est **whoma**, tranché le 5 septembre 2026 — la maquette porte encore « Bail » et le dossier `maquette_interface/bail/` garde ce chemin. Attention, « bail » est aussi le nom commun du contrat : ne jamais renommer à l’aveugle. Pour un écran ou un état absent de la maquette, suis `docs/design-system.md` et les composants existants.
